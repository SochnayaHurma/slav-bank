    ...
    <div class="container">
      ...
      <div class="bento">
        <div class="bento-card" style="padding: var(--s-4); position:relative;">
              ...
              <h3><strong> Форма запроса на кредитование СМП</strong><br></h3>
...
<!-- <form action="/zapros-na-kreditovanie-msp.html#wpcf7-f21599-p21602-o1" method="post" class="wpcf7-form init" aria-label="Контактная форма" novalidate="novalidate" data-status="init">

<p><label> Наименование организации/ИП<br>
<span class="wpcf7-form-control-wrap" data-name="your-name"><input size="40" maxlength="400" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" value="" type="text" name="your-name"></span> </label>
</p>
<p><label> ИНН<br>
<span class="wpcf7-form-control-wrap" data-name="text-921"><input size="40" maxlength="400" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" value="" type="text" name="text-921"></span> </label>
</p>
...
<p><label> Укажите необходимую дополнительную информацию:<br>
<span class="wpcf7-form-control-wrap" data-name="your-message"><textarea cols="40" rows="10" maxlength="2000" class="wpcf7-form-control wpcf7-textarea" aria-invalid="false" name="your-message">1)Запрашиваемая сумма -

2)Срок кредитования -

3)Выручка (за период) -

4)Возможное обеспечение -</textarea></span><br>
</label>
</p>
...
</p><p style="display: none !important;" class="akismet-fields-container" data-prefix="_wpcf7_ak_"><label>Δ<textarea name="_wpcf7_ak_hp_textarea" cols="45" rows="8" maxlength="100"></textarea></label><input type="hidden" id="ak_js_1" name="_wpcf7_ak_js" value="1774743934338"><script>document.getElementById( "ak_js_1" ).setAttribute( "value", ( new Date() ).getTime() );</script></p><div class="wpcf7-response-output" aria-hidden="true"></div>
</form> -->
            </div>
          </div>
