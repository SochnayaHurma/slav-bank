      ...
      <div class="hero-wrap" style="padding: var(--s-5)">
        ...
        >
          <div style="min-width: 280px; flex: 1 1 520px">
            ...
            <h1 style="margin: 8px 0 10px">Информация для нотариусов</h1>
            <p class="muted" style="max-width: 78ch">
              АО НКБ «СЛАВЯНБАНК» информирует о том, что не практикует выдачу
              доверенностей на бумажном носителе в простой письменной форме для
              целей направления нотариусу уведомлений о залоге.
            </p>
