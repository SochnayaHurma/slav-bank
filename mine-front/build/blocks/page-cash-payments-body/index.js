...
/***/ "./src/blocks/page-cash-payments-body/edit.js"
/*!****************************************************!*\
  !*** ./src/blocks/page-cash-payments-body/edit.js ***!
  \****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const TEMPLATE = [['slav-bank/page-pattern-alert', {
  ...
  content: 'АО НКБ «СЛАВЯНБАНК» осуществляет прием наличных денежных средств в кассу Банка, пересчет и зачисление на счет внесенных или инкассированных денежных средств Клиента.'
}]]], ['core/group', {
  className: 'summary-card'
}, [['slav-bank/kicker', {
  text: 'Требования'
  ...
  className: 'summary-text',
  content: 'Для получения наличных денежных средств со счета необходимо оформить денежную чековую книжку.'
}]]], ['core/group', {
  className: 'summary-card'
}, [['slav-bank/kicker', {
  text: 'Сроки'
  ...
  className: 'summary-text',
  content: 'Оформление чековой книжки производится на основании письменного заявления Клиента не позднее рабочего дня Банка, следующего за днем подачи заявления.'
}]]]]], ['slav-bank/page-pattern-chips', {
  items: [{
    id: 'cash-1',
    text: 'Шаблон объявления на взнос наличными (MS Excel)',
    url: 'https://slavbank.ru/obyavlenie-na-vznos-nalichnymi-instrukcziya.html',
    opensInNewTab: true
  }, {
    id: 'cash-2',
    text: 'Оформление чековой книжки',
    url: 'https://slavbank.ru/wp-content/uploads/newcheck.doc',
    opensInNewTab: true
  }]
}], ['slav-bank/page-pattern-documents', {
  items: [{
    id: 'cash-doc-1',
    title: 'Оформление чековой книжки',
    url: 'https://slavbank.ru/wp-content/uploads/newcheck.doc',
    format: 'DOC',
    symbol: '→',
    opensInNewTab: true
  ...
  items: [{
    id: 'cash-list-1',
    text: 'Выдача наличных денежных средств осуществляется на основании надлежащим образом оформленного денежного чека.'
  }, {
    id: 'cash-list-2',
    text: 'Доставка наличных денежных средств по заявке Клиента осуществляется на основании договора между Банком и Клиентом.'
  }, {
    id: 'cash-list-3',
    text: 'Прием наличных в кассу Банка выполняется на основании объявления на взнос наличными установленной формы.'
  }, {
    id: 'cash-list-4',
    text: 'Банк принимает ветхие наличные денежные средства и зачисляет их на расчетный счет Клиента по номинальной стоимости.'
  }, {
    id: 'cash-list-5',
    text: 'По просьбе Клиента Банк производит обмен банкнот на купюры другого достоинства или монету.'
  }, {
    id: 'cash-list-6',
    text: 'При необходимости Банк проводит экспертизу денежных знаков и выдает справку о приеме на экспертизу.'
  }]
}], ['core/paragraph', {
...
/***/ "./src/blocks/page-cash-payments-body/index.js"
/*!*****************************************************!*\
  !*** ./src/blocks/page-cash-payments-body/index.js ***!
  \*****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/page-cash-payments-body/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/page-cash-payments-body/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/page-cash-payments-body/save.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/page-cash-payments-body/editor.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/page-cash-payments-body/style.scss");
...
/***/ "./src/blocks/page-cash-payments-body/save.js"
/*!****************************************************!*\
  !*** ./src/blocks/page-cash-payments-body/save.js ***!
  \****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* reexport safe */ _page_pattern__WEBPACK_IMPORTED_MODULE_0__.bodySave)
/* harmony export */ });
/* harmony import */ var _page_pattern__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../page-pattern */ "./src/blocks/page-pattern.js");
...
/***/ "./src/blocks/page-cash-payments-body/editor.scss"
/*!********************************************************!*\
  !*** ./src/blocks/page-cash-payments-body/editor.scss ***!
  \********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-cash-payments-body/style.scss"
/*!*******************************************************!*\
  !*** ./src/blocks/page-cash-payments-body/style.scss ***!
  \*******************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-cash-payments-body/block.json"
/*!*******************************************************!*\
  !*** ./src/blocks/page-cash-payments-body/block.json ***!
  \*******************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"slav-bank/body-cash-payments","title":"Наличные расчеты: содержимое","category":"Наполнение","icon":"media-document","description":"Карточка содержимого страницы Наличные расчеты.","parent":["slav-bank/body-cash-payments-bento"],"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","supports":{"html":false,"anchor":true,"spacing":{"padding":true,"margin":true},"layout":true}}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/page-cash-payments-body/index": 0,
/******/ 			"blocks/page-cash-payments-body/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/page-cash-payments-body/style-index"], () => (__webpack_require__("./src/blocks/page-cash-payments-body/index.js")))
