...
/***/ "./src/blocks/page-fx-account-service-body/edit.js"
/*!*********************************************************!*\
  !*** ./src/blocks/page-fx-account-service-body/edit.js ***!
  \*********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const TEMPLATE = [['slav-bank/page-pattern-alert', {
  ...
  items: [{
    id: 'fx-1',
    text: 'Расчетно-кассовое обслуживание счета в иностранной валюте.'
  }, {
    id: 'fx-2',
    text: 'Формирование и предоставление выписок о движении и остатках денежных средств.'
  }, {
    id: 'fx-3',
    text: 'Выдача справок по письменной просьбе клиента.'
  }, {
    id: 'fx-4',
    text: 'Выдача дубликатов платежно-расчетных документов и выписок по счету.'
  }, {
    id: 'fx-5',
    text: 'Оформление платежных документов при расчетах в иностранной валюте.'
  }, {
    id: 'fx-6',
    text: 'Закрытие счета в иностранной валюте.'
  }]
}], ['slav-bank/kicker', {
  ...
  items: [{
    id: 'fx-op-1',
    text: 'Зачисление безналичных денежных средств в иностранной валюте на счета.'
  }, {
    id: 'fx-op-2',
    text: 'Прием и исполнение распоряжений на распределение экспортной выручки.'
  }, {
    id: 'fx-op-3',
    text: 'Прием и исполнение заявлений на перевод денежных средств в иностранной валюте за границу или на территории РФ.'
  }, {
    id: 'fx-op-4',
    text: 'Конвертация одной иностранной валюты в другую иностранную валюту.'
  }, {
    id: 'fx-op-5',
    text: 'Покупка и продажа безналичной иностранной валюты на ВВР.'
  }, {
    id: 'fx-op-6',
    text: 'Прием и отправка платежных документов на инкассо.'
  }, {
    id: 'fx-op-7',
    text: 'Установление маршрута прохождения перечисленных сумм.'
  }, {
    id: 'fx-op-8',
...
/***/ "./src/blocks/page-fx-account-service-body/index.js"
/*!**********************************************************!*\
  !*** ./src/blocks/page-fx-account-service-body/index.js ***!
  \**********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/page-fx-account-service-body/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/page-fx-account-service-body/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/page-fx-account-service-body/save.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/page-fx-account-service-body/editor.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/page-fx-account-service-body/style.scss");
...
/***/ "./src/blocks/page-fx-account-service-body/save.js"
/*!*********************************************************!*\
  !*** ./src/blocks/page-fx-account-service-body/save.js ***!
  \*********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-fx-account-service-body/editor.scss"
/*!*************************************************************!*\
  !*** ./src/blocks/page-fx-account-service-body/editor.scss ***!
  \*************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-fx-account-service-body/style.scss"
/*!************************************************************!*\
  !*** ./src/blocks/page-fx-account-service-body/style.scss ***!
  \************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-fx-account-service-body/block.json"
/*!************************************************************!*\
  !*** ./src/blocks/page-fx-account-service-body/block.json ***!
  \************************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"slav-bank/body-fx-account-service","title":"Обслуживание счетов в иностранной валюте: содержимое","category":"Наполнение","icon":"media-document","description":"Карточка содержимого страницы Обслуживание счетов в иностранной валюте.","parent":["slav-bank/body-fx-account-service-bento"],"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","supports":{"html":false,"anchor":true,"spacing":{"padding":true,"margin":true},"layout":true}}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/page-fx-account-service-body/index": 0,
/******/ 			"blocks/page-fx-account-service-body/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/page-fx-account-service-body/style-index"], () => (__webpack_require__("./src/blocks/page-fx-account-service-body/index.js")))
