...
/***/ "./src/blocks/page-security-body/edit.js"
/*!***********************************************!*\
  !*** ./src/blocks/page-security-body/edit.js ***!
  \***********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const TEMPLATE = [['slav-bank/title', {
  ...
  content: 'Любые иные интернет-сайты, содержащие в доменном имени указание на принадлежность к Банку, а также содержащие на своих страницах логотип и наименование Банка, могут использоваться для заражения устройств вредоносным ПО и получения конфиденциальных данных.',
  className: 'has-text-align-justify'
}], ['core/paragraph', {
  content: 'При совершении действий в сети Интернет обращайте внимание на доменное имя сайта: <a href="https://slavbank.ru/">www.slavbank.ru</a> или <a href="https://dbo.slavbank.ru:20101/">dbo.slavbank.ru</a>.',
  className: 'has-text-align-justify'
}]];
...
/***/ "./src/blocks/page-security-body/index.js"
/*!************************************************!*\
  !*** ./src/blocks/page-security-body/index.js ***!
  \************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/page-security-body/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/page-security-body/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/page-security-body/save.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/page-security-body/editor.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/page-security-body/style.scss");
...
/***/ "./src/blocks/page-security-body/save.js"
/*!***********************************************!*\
  !*** ./src/blocks/page-security-body/save.js ***!
  \***********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-security-body/editor.scss"
/*!***************************************************!*\
  !*** ./src/blocks/page-security-body/editor.scss ***!
  \***************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-security-body/style.scss"
/*!**************************************************!*\
  !*** ./src/blocks/page-security-body/style.scss ***!
  \**************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-security-body/block.json"
/*!**************************************************!*\
  !*** ./src/blocks/page-security-body/block.json ***!
  \**************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"slav-bank/body-security","title":"Рекомендации по безопасности: содержимое","category":"Наполнение","icon":"media-document","description":"Карточка содержимого страницы Рекомендации по безопасности.","parent":["slav-bank/body-security-bento"],"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","supports":{"html":false,"anchor":true,"spacing":{"padding":true,"margin":true},"layout":true}}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/page-security-body/index": 0,
/******/ 			"blocks/page-security-body/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/page-security-body/style-index"], () => (__webpack_require__("./src/blocks/page-security-body/index.js")))
