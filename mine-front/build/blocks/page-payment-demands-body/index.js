...
/***/ "./src/blocks/page-payment-demands-body/edit.js"
/*!******************************************************!*\
  !*** ./src/blocks/page-payment-demands-body/edit.js ***!
  \******************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const TEMPLATE = [['slav-bank/page-pattern-alert', {
  ...
  content: 'При предоставлении Клиентом права Банк оплачивает платежные требования с акцептом.'
}]]], ['core/group', {
  className: 'summary-card'
}, [['slav-bank/kicker', {
  ...
  className: 'summary-text',
  content: 'Прием и отправка платежных документов на инкассо.'
}]]], ['core/group', {
  className: 'summary-card'
}, [['slav-bank/kicker', {
  text: 'Что важно'
  ...
  className: 'summary-text',
  content: 'Банк принимает на инкассо платежные документы и отгрузочные документы к ним.'
}]]]]], ['slav-bank/page-pattern-list', {
  items: [{
    id: 'pd-1',
    text: 'При предоставлении Клиентом права Банк оплачивает платежные требования с акцептом.'
  }, {
    id: 'pd-2',
    text: 'Банк принимает на инкассо платежные документы и отгрузочные документы к ним.'
  }, {
    id: 'pd-3',
    text: 'Клиенту выдается экземпляр платежных документов с отметкой Банка о приеме к исполнению.'
  }, {
    id: 'pd-4',
    text: 'Установление маршрута прохождения перечисленных сумм осуществляется на основании письменного заявления Клиента.'
  }]
}], ['core/paragraph', {
...
/***/ "./src/blocks/page-payment-demands-body/index.js"
/*!*******************************************************!*\
  !*** ./src/blocks/page-payment-demands-body/index.js ***!
  \*******************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/page-payment-demands-body/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/page-payment-demands-body/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/page-payment-demands-body/save.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/page-payment-demands-body/editor.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/page-payment-demands-body/style.scss");
...
/***/ "./src/blocks/page-payment-demands-body/save.js"
/*!******************************************************!*\
  !*** ./src/blocks/page-payment-demands-body/save.js ***!
  \******************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-payment-demands-body/editor.scss"
/*!**********************************************************!*\
  !*** ./src/blocks/page-payment-demands-body/editor.scss ***!
  \**********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-payment-demands-body/style.scss"
/*!*********************************************************!*\
  !*** ./src/blocks/page-payment-demands-body/style.scss ***!
  \*********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-payment-demands-body/block.json"
/*!*********************************************************!*\
  !*** ./src/blocks/page-payment-demands-body/block.json ***!
  \*********************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"slav-bank/body-payment-demands","title":"Платежные требования с акцептом: содержимое","category":"Наполнение","icon":"media-document","description":"Карточка содержимого страницы Платежные требования с акцептом.","parent":["slav-bank/body-payment-demands-bento"],"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","supports":{"html":false,"anchor":true,"spacing":{"padding":true,"margin":true},"layout":true}}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/page-payment-demands-body/index": 0,
/******/ 			"blocks/page-payment-demands-body/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/page-payment-demands-body/style-index"], () => (__webpack_require__("./src/blocks/page-payment-demands-body/index.js")))
