...
/***/ "./src/blocks/page-client-bank-online-body/edit.js"
/*!*********************************************************!*\
  !*** ./src/blocks/page-client-bank-online-body/edit.js ***!
  \*********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const TEMPLATE = [['slav-bank/kicker', {
  text: 'Дистанционное обслуживание'
}], ['slav-bank/title', {
  title: 'Клиент-Банк Online',
  level: '2'
}], ['core/paragraph', {
  content: 'Система «Клиент-Банк» позволяет обмениваться документами с банком и работать с расчетными счетами без посещения офиса.'
}], ['core/list', {
  values: '<ul><li>отправка платежных поручений в банк</li><li>официальная переписка с применением ЭЦП</li><li>получение выписок и уведомлений</li><li>отправка валютных переводов и справок по валютным операциям</li><li>получение справок и иных банковских документов</li></ul>'
}], ['core/paragraph', {
  content: 'Банк имеет необходимые сертификаты для работы со средствами криптографической защиты информации.',
  className: 'muted'
...
/***/ "./src/blocks/page-client-bank-online-body/index.js"
/*!**********************************************************!*\
  !*** ./src/blocks/page-client-bank-online-body/index.js ***!
  \**********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/page-client-bank-online-body/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/page-client-bank-online-body/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/page-client-bank-online-body/save.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/page-client-bank-online-body/editor.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/page-client-bank-online-body/style.scss");
...
/***/ "./src/blocks/page-client-bank-online-body/save.js"
/*!*********************************************************!*\
  !*** ./src/blocks/page-client-bank-online-body/save.js ***!
  \*********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-client-bank-online-body/editor.scss"
/*!*************************************************************!*\
  !*** ./src/blocks/page-client-bank-online-body/editor.scss ***!
  \*************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-client-bank-online-body/style.scss"
/*!************************************************************!*\
  !*** ./src/blocks/page-client-bank-online-body/style.scss ***!
  \************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-client-bank-online-body/block.json"
/*!************************************************************!*\
  !*** ./src/blocks/page-client-bank-online-body/block.json ***!
  \************************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"slav-bank/body-client-bank-online","title":"Клиент-Банк Online: содержимое","category":"Наполнение","icon":"media-document","description":"Карточка содержимого страницы Клиент-Банк Online.","parent":["slav-bank/body-client-bank-online-bento"],"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","supports":{"html":false,"anchor":true,"spacing":{"padding":true,"margin":true},"layout":true}}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/page-client-bank-online-body/index": 0,
/******/ 			"blocks/page-client-bank-online-body/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/page-client-bank-online-body/style-index"], () => (__webpack_require__("./src/blocks/page-client-bank-online-body/index.js")))
