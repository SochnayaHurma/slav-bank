...
/***/ "./src/blocks/page-currency-control-body/edit.js"
/*!*******************************************************!*\
  !*** ./src/blocks/page-currency-control-body/edit.js ***!
  \*******************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const TEMPLATE = [['slav-bank/kicker', {
  ...
  content: 'Банк сопровождает клиентов при проведении валютных операций и помогает подготовить комплект документов в соответствии с требованиями законодательства.'
}], ['slav-bank/page-pattern-list', {
  items: [{
    id: 'cc-1',
    text: 'Проверка документов по валютным операциям и внешнеторговым контрактам.'
  }, {
    id: 'cc-2',
    text: 'Консультации по заполнению форм и справок валютного контроля.'
  }, {
    id: 'cc-3',
    text: 'Сопровождение переводов в иностранной валюте и контроль сроков.'
  }]
}], ['core/paragraph', {
  content: 'Перед отправкой документов уточните актуальные требования у профильного специалиста банка.',
  className: 'muted'
...
/***/ "./src/blocks/page-currency-control-body/index.js"
/*!********************************************************!*\
  !*** ./src/blocks/page-currency-control-body/index.js ***!
  \********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/page-currency-control-body/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/page-currency-control-body/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/page-currency-control-body/save.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/page-currency-control-body/editor.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/page-currency-control-body/style.scss");
...
/***/ "./src/blocks/page-currency-control-body/save.js"
/*!*******************************************************!*\
  !*** ./src/blocks/page-currency-control-body/save.js ***!
  \*******************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-currency-control-body/editor.scss"
/*!***********************************************************!*\
  !*** ./src/blocks/page-currency-control-body/editor.scss ***!
  \***********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-currency-control-body/style.scss"
/*!**********************************************************!*\
  !*** ./src/blocks/page-currency-control-body/style.scss ***!
  \**********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-currency-control-body/block.json"
/*!**********************************************************!*\
  !*** ./src/blocks/page-currency-control-body/block.json ***!
  \**********************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"slav-bank/body-currency-control","title":"Валютный контроль: содержимое","category":"Наполнение","icon":"media-document","description":"Карточка содержимого страницы Валютный контроль.","parent":["slav-bank/body-currency-control-bento"],"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","supports":{"html":false,"anchor":true,"spacing":{"padding":true,"margin":true},"layout":true}}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/page-currency-control-body/index": 0,
/******/ 			"blocks/page-currency-control-body/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/page-currency-control-body/style-index"], () => (__webpack_require__("./src/blocks/page-currency-control-body/index.js")))
