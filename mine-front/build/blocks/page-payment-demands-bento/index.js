...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"slav-bank/body-payment-demands-bento","title":"Платежные требования с акцептом bento","category":"Наполнение","icon":"screenoptions","description":"Bento-секция страницы Платежные требования с акцептом.","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","supports":{"html":false,"anchor":true,"spacing":{"padding":true,"margin":true},"layout":true}}');
