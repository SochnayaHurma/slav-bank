...
/***/ "./src/blocks/page-covid19-body/edit.js"
/*!**********************************************!*\
  !*** ./src/blocks/page-covid19-body/edit.js ***!
  \**********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const TEMPLATE = [['slav-bank/page-pattern-alert', {
  ...
  content: '<strong>Информация для Заемщиков АО НКБ «СЛАВЯНБАНК»:</strong>'
}], ['slav-bank/page-pattern-list', {
  items: [{
    id: 'covid-item-1',
    text: 'физическое лицо, индивидуальный предприниматель;'
  }, {
    id: 'covid-item-2',
    text: 'субъект малого и среднего предпринимательства, осуществляющий деятельность в наиболее пострадавших отраслях, определенных Правительством Российской Федерации.'
  }]
}], ['core/paragraph', {
  content: '<strong>Заемщик, заключивший до 03 апреля 2020 года кредитный договор, вправе обратиться в Банк с требованием об изменении его условий.</strong>'
}], ['core/paragraph', {
  content: 'Изменения условий предусматривают приостановление исполнения заемщиком своих обязательств на срок, определенный заемщиком («Льготный период»).'
}], ['core/paragraph', {
  content: 'Период предоставляется в соответствии с Федеральным законом от 03.04.2020 №106-ФЗ. Закон определяет порядок начисления и уплаты процентов и иных платежей после установления «Льготного периода», а также прочие условия и возможные последствия его установления.'
}]];
...
/***/ "./src/blocks/page-covid19-body/index.js"
/*!***********************************************!*\
  !*** ./src/blocks/page-covid19-body/index.js ***!
  \***********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/page-covid19-body/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/page-covid19-body/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/page-covid19-body/save.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/page-covid19-body/editor.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/page-covid19-body/style.scss");
...
/***/ "./src/blocks/page-covid19-body/save.js"
/*!**********************************************!*\
  !*** ./src/blocks/page-covid19-body/save.js ***!
  \**********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-covid19-body/editor.scss"
/*!**************************************************!*\
  !*** ./src/blocks/page-covid19-body/editor.scss ***!
  \**************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-covid19-body/style.scss"
/*!*************************************************!*\
  !*** ./src/blocks/page-covid19-body/style.scss ***!
  \*************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-covid19-body/block.json"
/*!*************************************************!*\
  !*** ./src/blocks/page-covid19-body/block.json ***!
  \*************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"slav-bank/body-covid19","title":"COVID19: содержимое","category":"Наполнение","icon":"media-document","description":"Карточка содержимого страницы COVID19.","parent":["slav-bank/body-covid19-bento"],"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","supports":{"html":false,"anchor":true,"spacing":{"padding":true,"margin":true},"layout":true}}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/page-covid19-body/index": 0,
/******/ 			"blocks/page-covid19-body/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/page-covid19-body/style-index"], () => (__webpack_require__("./src/blocks/page-covid19-body/index.js")))
