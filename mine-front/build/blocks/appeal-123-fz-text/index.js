...
/***/ "./src/blocks/appeal-123-fz-text/edit.js"
/*!***********************************************!*\
  !*** ./src/blocks/appeal-123-fz-text/edit.js ***!
  \***********************************************/
...
const group = (className, innerBlocks) => ['core/group', {
  className
}, innerBlocks];
const TEMPLATE = [group('has-background', [paragraph('<strong>Обращение по 123-ФЗ</strong>', {
  className: 'has-text-color has-link-color has-huge-font-size'
}), paragraph('О финансовом уполномоченном и обращении к нему')]), paragraph('Если у вас есть спор с банком, который не решается в вашу пользу, можно обратиться к финансовому уполномоченному. Новый досудебный порядок применяется к спорам от 1 января 2021 года и суммой до 500 000 ₽.'), paragraph('<strong>Обращение можно отправить </strong>через личный кабинет на сайте финансового уполномоченного по адресу: <a href="https://finombudsman.ru/lk/login." target="_blank" rel="noreferrer noopener">https://finombudsman.ru/lk/login.</a>'), paragraph('<strong>Важно</strong>: по закону <strong>(<a href="https://finombudsman.ru/kb/glossarij/zakon-123-fz.html">№ 123-ФЗ от 04.06.2018</a>)</strong>, если вы ещё не составляли обращение в банке, вам нужно сделать это до обращения к финансовому уполномоченному. Чтобы рассмотреть обращение, нам потребуется заявление с вашей подписью и документы, которые помогут разобраться в ситуации.'), group('', [group('has-background', [paragraph('Отправьте заявление и документы на <a href="mailto:nkb@slavbank.ru" target="_blank" rel="noreferrer noopener"><strong>nkb@slavbank.ru</strong></a> и позвоните по телефону: +7 (8162) 66-52-47.'), paragraph('Подробнее о том, как подать обращение к финансовому уполномоченному, можно узнать здесь:')])]), ['slav-bank/page-pattern-list', {
...
/***/ "./src/blocks/appeal-123-fz-text/index.js"
/*!************************************************!*\
  !*** ./src/blocks/appeal-123-fz-text/index.js ***!
  \************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/appeal-123-fz-text/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/appeal-123-fz-text/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/appeal-123-fz-text/save.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/appeal-123-fz-text/editor.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/appeal-123-fz-text/style.scss");
...
/***/ "./src/blocks/appeal-123-fz-text/save.js"
/*!***********************************************!*\
  !*** ./src/blocks/appeal-123-fz-text/save.js ***!
  \***********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/appeal-123-fz-text/editor.scss"
/*!***************************************************!*\
  !*** ./src/blocks/appeal-123-fz-text/editor.scss ***!
  \***************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/appeal-123-fz-text/style.scss"
/*!**************************************************!*\
  !*** ./src/blocks/appeal-123-fz-text/style.scss ***!
  \**************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/appeal-123-fz-text/block.json"
/*!**************************************************!*\
  !*** ./src/blocks/appeal-123-fz-text/block.json ***!
  \**************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"slav-bank/appeal-123-fz-text","title":"Обращение по 123-ФЗ: текст","category":"Компоненты темы","icon":"text-page","description":"Текст страницы обращения по 123-ФЗ.","parent":["slav-bank/body-appeal-123-fz"],"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","supports":{"html":false,"anchor":true,"spacing":{"padding":true,"margin":true},"layout":true}}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/appeal-123-fz-text/index": 0,
/******/ 			"blocks/appeal-123-fz-text/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/appeal-123-fz-text/style-index"], () => (__webpack_require__("./src/blocks/appeal-123-fz-text/index.js")))
