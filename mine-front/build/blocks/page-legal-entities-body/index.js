...
/***/ "./src/blocks/page-legal-entities-body/edit.js"
/*!*****************************************************!*\
  !*** ./src/blocks/page-legal-entities-body/edit.js ***!
  \*****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const TEMPLATE = [['slav-bank/page-pattern-alert', {
  ...
  items: [{
    id: 'le-1',
    text: 'Кредитование юридических лиц и предпринимателей в рублях и иностранной валюте'
  }, {
    id: 'le-2',
    text: 'Обслуживание счетов в валюте РФ (открытие, ведение, наличные и безналичные расчеты)'
  }, {
    id: 'le-3',
    text: 'Обслуживание счетов в иностранной валюте'
  }, {
    id: 'le-4',
    text: 'Валютный контроль и консультации специалистов по валютным операциям'
  }]
}], ['slav-bank/page-pattern-chips', {
  items: [{
    id: 'le-link-1',
    text: 'Кредитование',
    url: '/yuridicheskim-liczam-html/kreditovanie-yuridicheskih-licz.html/'
  }, {
    id: 'le-link-2',
    text: 'Счета в валюте РФ',
    url: '/yuridicheskim-liczam-html/obsluzivanie-schetov-rf.html/'
  }, {
    id: 'le-link-3',
    text: 'Счета в иностранной валюте',
    url: '/yuridicheskim-liczam-html/obsluzivanie-valut-schetov.html/'
  }, {
    id: 'le-link-4',
    text: 'Валютный контроль',
    url: '/yuridicheskim-liczam-html/valutny-kontrol/'
  }]
}], ['core/paragraph', {
...
/***/ "./src/blocks/page-legal-entities-body/index.js"
/*!******************************************************!*\
  !*** ./src/blocks/page-legal-entities-body/index.js ***!
  \******************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/page-legal-entities-body/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/page-legal-entities-body/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/page-legal-entities-body/save.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/page-legal-entities-body/editor.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/page-legal-entities-body/style.scss");
...
/***/ "./src/blocks/page-legal-entities-body/save.js"
/*!*****************************************************!*\
  !*** ./src/blocks/page-legal-entities-body/save.js ***!
  \*****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-legal-entities-body/editor.scss"
/*!*********************************************************!*\
  !*** ./src/blocks/page-legal-entities-body/editor.scss ***!
  \*********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-legal-entities-body/style.scss"
/*!********************************************************!*\
  !*** ./src/blocks/page-legal-entities-body/style.scss ***!
  \********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-legal-entities-body/block.json"
/*!********************************************************!*\
  !*** ./src/blocks/page-legal-entities-body/block.json ***!
  \********************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"slav-bank/body-legal-entities","title":"Юридическим лицам: содержимое","category":"Наполнение","icon":"media-document","description":"Карточка содержимого страницы Юридическим лицам.","parent":["slav-bank/body-legal-entities-bento"],"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","supports":{"html":false,"anchor":true,"spacing":{"padding":true,"margin":true},"layout":true}}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/page-legal-entities-body/index": 0,
/******/ 			"blocks/page-legal-entities-body/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/page-legal-entities-body/style-index"], () => (__webpack_require__("./src/blocks/page-legal-entities-body/index.js")))
