...
/***/ "./src/blocks/aml-fatca-text/edit.js"
/*!*******************************************!*\
  !*** ./src/blocks/aml-fatca-text/edit.js ***!
  \*******************************************/
...
const paragraph = content => ['core/paragraph', {
  content
}];
const separator = () => ['core/separator', {
  className: 'has-alpha-channel-opacity'
}];
const TEMPLATE = [paragraph('I. <strong>ПРОТИВОДЕЙСТВИЕ ЛЕГАЛИЗАЦИИ ДОХОДОВ</strong>'), paragraph('АО НКБ «СЛАВЯНБАНК» уделяет повышенное внимание противодействию легализации (отмыванию) доходов, полученных преступным путем, финансированию терроризма, экстремистской деятельности и финансированию распространения оружия массового уничтожения <strong>(ПОД/ФТ/ЭД/ФРОМУ)</strong>.'), paragraph('Банк в своей деятельности руководствуется Федеральным законом от 07.08.2001 №115-ФЗ «О противодействии легализации (отмыванию) доходов, полученных преступным путем, и финансированию терроризма» и выполняет следующие обязанности:'), ['slav-bank/page-pattern-list', {
  items: [{
    id: 'identify-clients',
...
}], separator(), paragraph('II. <strong>МЕЖДУНАРОДНЫЕ ОГРАНИЧЕНИЯ</strong>'), paragraph('АО НКБ «СЛАВЯНБАНК» ведет деятельность на территории Российской Федерации в соответствии с законодательством Российской Федерации и выданными Банком России лицензиями.'), paragraph('Банк обязан всесторонне анализировать своих клиентов и проводимые ими операции в целях недопущения вовлечения Банка в сделки и операции, сопряженные с высокими репутационными, геополитическими и иными рисками.'), paragraph('Убедительно просим вас проявлять осмотрительность в отношении ваших контрагентов, а также своевременно предоставлять необходимые и дополнительно запрошенные банком документы и пояснения.'), separator(), paragraph('III. <strong>FATCA</strong>'), paragraph('Банк принимает меры по выявлению среди клиентов лиц, на которых распространяется законодательство иностранного государства о налогообложении иностранных счетов.'), paragraph('В соответствии с требованиями Закона США «О налогообложении иностранных счетов» (Foreign Account Tax Compliance Act) Банк заключил соглашение с Налоговым управлением США (IRS) и зарегистрировался на сайте <a href="http://www.irs.gov/" target="_blank" rel="noreferrer noopener">Налогового управления США</a>.'), paragraph('<strong>Форма </strong>подтверждения статуса АО НКБ «СЛАВЯНБАНК» и указанием FATCA-статуса: <strong><a href="https://slavbank.ru/wp-content/uploads/w-8ben.pdf" target="_blank" rel="noreferrer noopener">Анкета W-8BEN</a></strong>'), paragraph('<strong>Критерии отнесения клиентов Банка к категории налогоплательщика США</strong>'), ['slav-bank/page-pattern-list', {
  items: [{
    id: 'born-usa',
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_page_pattern__WEBPACK_IMPORTED_MODULE_0__.createProseEdit)(TEMPLATE));

/***/ },

/***/ "./src/blocks/aml-fatca-text/index.js"
/*!********************************************!*\
  !*** ./src/blocks/aml-fatca-text/index.js ***!
  \********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/aml-fatca-text/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/aml-fatca-text/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/aml-fatca-text/save.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/aml-fatca-text/editor.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/aml-fatca-text/style.scss");
...
/***/ "./src/blocks/aml-fatca-text/save.js"
/*!*******************************************!*\
  !*** ./src/blocks/aml-fatca-text/save.js ***!
  \*******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* reexport safe */ _page_pattern__WEBPACK_IMPORTED_MODULE_0__.proseSave)
/* harmony export */ });
/* harmony import */ var _page_pattern__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../page-pattern */ "./src/blocks/page-pattern.js");
...
/***/ "./src/blocks/aml-fatca-text/editor.scss"
/*!***********************************************!*\
  !*** ./src/blocks/aml-fatca-text/editor.scss ***!
  \***********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/aml-fatca-text/style.scss"
/*!**********************************************!*\
  !*** ./src/blocks/aml-fatca-text/style.scss ***!
  \**********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/aml-fatca-text/block.json"
/*!**********************************************!*\
  !*** ./src/blocks/aml-fatca-text/block.json ***!
  \**********************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"slav-bank/aml-fatca-text","title":"ПОД/ФТ/ФРОМУ/FATCA: текст","category":"Компоненты темы","icon":"text-page","description":"Текст страницы ПОД/ФТ/ФРОМУ/FATCA.","parent":["slav-bank/body-aml-fatca"],"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","supports":{"html":false,"anchor":true,"spacing":{"padding":true,"margin":true},"layout":true}}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/aml-fatca-text/index": 0,
/******/ 			"blocks/aml-fatca-text/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/aml-fatca-text/style-index"], () => (__webpack_require__("./src/blocks/aml-fatca-text/index.js")))
