...
/***/ "./src/blocks/page-cashless-payments/edit.js"
/*!***************************************************!*\
  !*** ./src/blocks/page-cashless-payments/edit.js ***!
  \***************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const TEMPLATE = [['slav-bank/hero-simple', {
  ...
  kicker: 'Раздел',
  description: 'АО НКБ «СЛАВЯНБАНК» осуществляет прием и исполнение поручений Клиента на перечисление денежных средств на основании надлежаще оформленных платежных поручений.',
  pillItems: [(0,_page_pattern__WEBPACK_IMPORTED_MODULE_0__.heroBadge)('Наличные', '/yuridicheskim-liczam-html/obsluzivanie-schetov-rf/nalichnye-raschety.html/'), (0,_page_pattern__WEBPACK_IMPORTED_MODULE_0__.heroBadge)('Счета', '/yuridicheskim-liczam-html/obsluzivanie-valut-schetov.html/'), (0,_page_pattern__WEBPACK_IMPORTED_MODULE_0__.heroBadge)('Требования', '/yuridicheskim-liczam-html/obsluzivanie-schetov-rf/platezhnye-trebovaniya-s-akczeptom.html/')],
  actions: [(0,_page_pattern__WEBPACK_IMPORTED_MODULE_0__.heroAction)('Содержание', '#content'), (0,_page_pattern__WEBPACK_IMPORTED_MODULE_0__.heroAction)('На главную', '/'), (0,_page_pattern__WEBPACK_IMPORTED_MODULE_0__.heroAction)('Задать вопрос', '/forma-obratnoj-svyazi.html/#form')]
...
/***/ "./src/blocks/page-cashless-payments/index.js"
/*!****************************************************!*\
  !*** ./src/blocks/page-cashless-payments/index.js ***!
  \****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/page-cashless-payments/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/page-cashless-payments/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/page-cashless-payments/save.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/page-cashless-payments/editor.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/page-cashless-payments/style.scss");
...
/***/ "./src/blocks/page-cashless-payments/save.js"
/*!***************************************************!*\
  !*** ./src/blocks/page-cashless-payments/save.js ***!
  \***************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-cashless-payments/editor.scss"
/*!*******************************************************!*\
  !*** ./src/blocks/page-cashless-payments/editor.scss ***!
  \*******************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-cashless-payments/style.scss"
/*!******************************************************!*\
  !*** ./src/blocks/page-cashless-payments/style.scss ***!
  \******************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-cashless-payments/block.json"
/*!******************************************************!*\
  !*** ./src/blocks/page-cashless-payments/block.json ***!
  \******************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"slav-bank/cashless-payments","title":"Страница Безналичные расчеты","category":"Страницы","icon":"screenoptions","description":"Страница Безналичные расчеты.","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","supports":{"html":false,"anchor":true,"spacing":{"padding":true,"margin":true},"layout":true}}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/page-cashless-payments/index": 0,
/******/ 			"blocks/page-cashless-payments/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/page-cashless-payments/style-index"], () => (__webpack_require__("./src/blocks/page-cashless-payments/index.js")))
