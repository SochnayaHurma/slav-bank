...
/***/ "./src/blocks/page-business-lending-body/edit.js"
/*!*******************************************************!*\
  !*** ./src/blocks/page-business-lending-body/edit.js ***!
  \*******************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const TEMPLATE = [['slav-bank/page-pattern-alert', {
  ...
  items: [{
    id: 'credit-1',
    text: 'Платежеспособность заемщика'
  }, {
    id: 'credit-2',
    text: 'Качество и ликвидность предлагаемого обеспечения'
  }, {
    id: 'credit-3',
    text: 'Кредитная история'
  }, {
    id: 'credit-4',
    text: 'Срок кредитов: до пяти лет'
  }, {
    id: 'credit-5',
    text: 'График погашения — удобный для клиента'
  }]
}], ['slav-bank/page-pattern-list', {
  items: [{
    id: 'credit-type-1',
    text: '<strong>Долгосрочный коммерческий кредит</strong> — 3-5 лет'
  }, {
    id: 'credit-type-2',
    text: '<strong>Среднесрочный коммерческий кредит</strong> — 1-3 года'
  }, {
    id: 'credit-type-3',
    text: '<strong>Краткосрочный коммерческий кредит</strong> — до 1 года'
  }, {
    id: 'credit-type-4',
    text: 'Возобновляемая кредитная линия'
  }, {
    id: 'credit-type-5',
    text: 'Кредитование расчетного счета «овердрафт»'
  }]
}], ['core/paragraph', {
...
/***/ "./src/blocks/page-business-lending-body/index.js"
/*!********************************************************!*\
  !*** ./src/blocks/page-business-lending-body/index.js ***!
  \********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/page-business-lending-body/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/page-business-lending-body/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/page-business-lending-body/save.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/page-business-lending-body/editor.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/page-business-lending-body/style.scss");
...
/***/ "./src/blocks/page-business-lending-body/save.js"
/*!*******************************************************!*\
  !*** ./src/blocks/page-business-lending-body/save.js ***!
  \*******************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-business-lending-body/editor.scss"
/*!***********************************************************!*\
  !*** ./src/blocks/page-business-lending-body/editor.scss ***!
  \***********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-business-lending-body/style.scss"
/*!**********************************************************!*\
  !*** ./src/blocks/page-business-lending-body/style.scss ***!
  \**********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-business-lending-body/block.json"
/*!**********************************************************!*\
  !*** ./src/blocks/page-business-lending-body/block.json ***!
  \**********************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"slav-bank/body-business-lending","title":"Кредитование юридических лиц: содержимое","category":"Наполнение","icon":"media-document","description":"Карточка содержимого страницы Кредитование юридических лиц.","parent":["slav-bank/body-business-lending-bento"],"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","supports":{"html":false,"anchor":true,"spacing":{"padding":true,"margin":true},"layout":true}}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/page-business-lending-body/index": 0,
/******/ 			"blocks/page-business-lending-body/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/page-business-lending-body/style-index"], () => (__webpack_require__("./src/blocks/page-business-lending-body/index.js")))
