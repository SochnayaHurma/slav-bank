...
/***/ "./src/blocks/page-info-bank-page-body/edit.js"
/*!*****************************************************!*\
  !*** ./src/blocks/page-info-bank-page-body/edit.js ***!
  \*****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const TEMPLATE = [['slav-bank/kicker', {
  ...
  title: 'Информация банка',
  level: '2'
}], ['core/paragraph', {
  content: 'Раздел объединяет обязательные сведения о банке, публикации для клиентов и документы, связанные с раскрытием информации.'
}], ['slav-bank/page-pattern-list', {
  items: [{
    id: 'ib-1',
    text: 'Реквизиты банка, контактные данные и сведения для платежных документов.'
  }, {
    id: 'ib-2',
    text: 'Финансовая отчетность и публикации в интересах клиентов и регулятора.'
  }, {
    id: 'ib-3',
    text: 'Внутренние документы, корпоративная информация и официальные сообщения.'
  }]
...
/***/ "./src/blocks/page-info-bank-page-body/index.js"
/*!******************************************************!*\
  !*** ./src/blocks/page-info-bank-page-body/index.js ***!
  \******************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/page-info-bank-page-body/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/page-info-bank-page-body/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/page-info-bank-page-body/save.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/page-info-bank-page-body/editor.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/page-info-bank-page-body/style.scss");
...
/***/ "./src/blocks/page-info-bank-page-body/save.js"
/*!*****************************************************!*\
  !*** ./src/blocks/page-info-bank-page-body/save.js ***!
  \*****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-info-bank-page-body/editor.scss"
/*!*********************************************************!*\
  !*** ./src/blocks/page-info-bank-page-body/editor.scss ***!
  \*********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-info-bank-page-body/style.scss"
/*!********************************************************!*\
  !*** ./src/blocks/page-info-bank-page-body/style.scss ***!
  \********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-info-bank-page-body/block.json"
/*!********************************************************!*\
  !*** ./src/blocks/page-info-bank-page-body/block.json ***!
  \********************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"slav-bank/body-info-bank-page","title":"Информация о банке: содержимое","category":"Наполнение","icon":"media-document","description":"Карточка содержимого страницы Информация о банке.","parent":["slav-bank/body-info-bank-page-bento"],"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","supports":{"html":false,"anchor":true,"spacing":{"padding":true,"margin":true},"layout":true}}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/page-info-bank-page-body/index": 0,
/******/ 			"blocks/page-info-bank-page-body/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/page-info-bank-page-body/style-index"], () => (__webpack_require__("./src/blocks/page-info-bank-page-body/index.js")))
