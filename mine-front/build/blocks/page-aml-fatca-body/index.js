...
/***/ "./src/blocks/page-aml-fatca-body/edit.js"
/*!************************************************!*\
  !*** ./src/blocks/page-aml-fatca-body/edit.js ***!
  \************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const card = (title, text) => ['core/group', {
...
}, [card('О чём раздел', 'I. ПРОТИВОДЕЙСТВИЕ ЛЕГАЛИЗАЦИИ ДОХОДОВ'), card('Кому важно', 'АО НКБ «СЛАВЯНБАНК» ведет деятельность на территории Российской Федерации в соответствии с законодательством Российской Федерации и выданными Банком России лицензиями.'), card('Что потребуется', 'Убедительно просим вас проявлять осмотрительность в отношении ваших контрагентов, а также своевременно предоставлять необходимые документы и пояснения.'), card('Как поможем', 'Основной целью Закона FATCA является противодействие уклонению от налогообложения в США доходов Налогоплательщиков США.')]], ['slav-bank/kicker', {
  text: 'Что полезно подготовить'
...
/***/ "./src/blocks/page-aml-fatca-body/index.js"
/*!*************************************************!*\
  !*** ./src/blocks/page-aml-fatca-body/index.js ***!
  \*************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/page-aml-fatca-body/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/page-aml-fatca-body/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/page-aml-fatca-body/save.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/page-aml-fatca-body/editor.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/page-aml-fatca-body/style.scss");
...
/***/ "./src/blocks/page-aml-fatca-body/save.js"
/*!************************************************!*\
  !*** ./src/blocks/page-aml-fatca-body/save.js ***!
  \************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-aml-fatca-body/editor.scss"
/*!****************************************************!*\
  !*** ./src/blocks/page-aml-fatca-body/editor.scss ***!
  \****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-aml-fatca-body/style.scss"
/*!***************************************************!*\
  !*** ./src/blocks/page-aml-fatca-body/style.scss ***!
  \***************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-aml-fatca-body/block.json"
/*!***************************************************!*\
  !*** ./src/blocks/page-aml-fatca-body/block.json ***!
  \***************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"slav-bank/body-aml-fatca","title":"ПОД/ФТ/ФРОМУ/FATCA: содержимое","category":"Наполнение","icon":"shield","description":"Карточка содержимого страницы ПОД/ФТ/ФРОМУ/FATCA.","parent":["slav-bank/body-aml-fatca-bento"],"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","supports":{"html":false,"anchor":true,"spacing":{"padding":true,"margin":true},"layout":true}}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/page-aml-fatca-body/index": 0,
/******/ 			"blocks/page-aml-fatca-body/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/page-aml-fatca-body/style-index"], () => (__webpack_require__("./src/blocks/page-aml-fatca-body/index.js")))
