...
/***/ "./src/blocks/page-vacancies-body/edit.js"
/*!************************************************!*\
  !*** ./src/blocks/page-vacancies-body/edit.js ***!
  \************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const TEMPLATE = [['core/paragraph', {
  content: 'Если вы <strong>активный, инициативный и целеустремленный</strong> человек, желающий работать и зарабатывать, мы всегда <strong>открыты для диалога</strong> с вами. Даже при отсутствии актуальных вакансий вы можете прислать нам своё резюме и мы обязательно его рассмотрим.'
}], ['slav-bank/title', {
  ...
  items: [{
    id: 'vacancy-1',
    text: 'Трудоустройство в соответствии с ТК РФ'
  }, {
    id: 'vacancy-2',
    text: 'Комфортные условия труда'
  }, {
    id: 'vacancy-3',
    text: 'Стабильная выплата заработной платы (два раза в месяц)'
  }, {
    id: 'vacancy-4',
    text: 'Возможности профессионального и карьерного роста'
  }, {
    id: 'vacancy-5',
    text: 'Дружный коллектив'
  }, {
    id: 'vacancy-6',
    text: 'Участие в вебинарах и семинарах'
  }]
}], ['core/image', {
  ...
  content: '<a href="mailto:nkb@slavbank.ru"><strong>Отправить резюме</strong></a> или связаться с нами по <strong><a href="/kontakty.html/">контактным телефонам</a></strong>.'
}]];
...
/***/ "./src/blocks/page-vacancies-body/index.js"
/*!*************************************************!*\
  !*** ./src/blocks/page-vacancies-body/index.js ***!
  \*************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/page-vacancies-body/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/page-vacancies-body/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/page-vacancies-body/save.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/page-vacancies-body/editor.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/page-vacancies-body/style.scss");
...
/***/ "./src/blocks/page-vacancies-body/save.js"
/*!************************************************!*\
  !*** ./src/blocks/page-vacancies-body/save.js ***!
  \************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-vacancies-body/editor.scss"
/*!****************************************************!*\
  !*** ./src/blocks/page-vacancies-body/editor.scss ***!
  \****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-vacancies-body/style.scss"
/*!***************************************************!*\
  !*** ./src/blocks/page-vacancies-body/style.scss ***!
  \***************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-vacancies-body/block.json"
/*!***************************************************!*\
  !*** ./src/blocks/page-vacancies-body/block.json ***!
  \***************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"slav-bank/body-vacancies","title":"Вакансии: содержимое","category":"Наполнение","icon":"media-document","description":"Карточка содержимого страницы Вакансии.","parent":["slav-bank/body-vacancies-bento"],"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","supports":{"html":false,"anchor":true,"spacing":{"padding":true,"margin":true},"layout":true}}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/page-vacancies-body/index": 0,
/******/ 			"blocks/page-vacancies-body/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/page-vacancies-body/style-index"], () => (__webpack_require__("./src/blocks/page-vacancies-body/index.js")))
