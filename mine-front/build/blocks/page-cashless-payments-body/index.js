...
/***/ "./src/blocks/page-cashless-payments-body/edit.js"
/*!********************************************************!*\
  !*** ./src/blocks/page-cashless-payments-body/edit.js ***!
  \********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const TEMPLATE = [['slav-bank/page-pattern-alert', {
  ...
  content: 'Для клиентов, использующих платежные поручения для безналичных переводов.'
}]]], ['core/group', {
  className: 'summary-card'
}, [['slav-bank/kicker', {
  text: 'Что можно'
  ...
  className: 'summary-text',
  content: 'Зачисление денежных средств на счет, прием и исполнение поручений на перечисление.'
}]]], ['core/group', {
  className: 'summary-card'
}, [['slav-bank/kicker', {
  text: 'Как начать'
  ...
  className: 'summary-text',
  content: 'Свяжитесь с банком для консультации по подключению и регламенту расчетов.'
}]]]]], ['slav-bank/page-pattern-list', {
  items: [{
    id: 'cashless-1',
    text: 'Денежные средства, поступившие на корреспондентский счет Банка в течение операционного дня, зачисляются текущим днем.'
  }, {
    id: 'cashless-2',
    text: 'Средства, поступившие после операционного дня, зачисляются на следующий день.'
  }, {
    id: 'cashless-3',
    text: 'Исполнение поручений производится не позднее следующего рабочего дня после подачи платежного поручения.'
  }]
}], ['core/paragraph', {
...
/***/ "./src/blocks/page-cashless-payments-body/index.js"
/*!*********************************************************!*\
  !*** ./src/blocks/page-cashless-payments-body/index.js ***!
  \*********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/page-cashless-payments-body/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/page-cashless-payments-body/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/page-cashless-payments-body/save.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/page-cashless-payments-body/editor.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/page-cashless-payments-body/style.scss");
...
/***/ "./src/blocks/page-cashless-payments-body/save.js"
/*!********************************************************!*\
  !*** ./src/blocks/page-cashless-payments-body/save.js ***!
  \********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-cashless-payments-body/editor.scss"
/*!************************************************************!*\
  !*** ./src/blocks/page-cashless-payments-body/editor.scss ***!
  \************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-cashless-payments-body/style.scss"
/*!***********************************************************!*\
  !*** ./src/blocks/page-cashless-payments-body/style.scss ***!
  \***********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/******/ 		var installedChunks = {
/******/ 			"blocks/page-cashless-payments-body/index": 0,
/******/ 			"blocks/page-cashless-payments-body/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/page-cashless-payments-body/style-index"], () => (__webpack_require__("./src/blocks/page-cashless-payments-body/index.js")))
