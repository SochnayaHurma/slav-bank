...
const TEMPLATE = [['slav-bank/hero-simple', {
  ...
  kicker: 'Раздел',
  description: 'Здесь вы найдете ответы на некоторые вопросы, возникающие при работе в системе Клиент-Банк. Стоит помнить, что сбои при входе или в работе системы Клиент-банк могут возникнуть из-за казалось бы незначительных на первый взгляд мелочей.',
  pillItems: [{
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/page-faq/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/page-faq/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/page-faq/save.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/page-faq/editor.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/page-faq/style.scss");
...
/***/ "./src/blocks/page-faq/editor.scss"
/*!*****************************************!*\
  !*** ./src/blocks/page-faq/editor.scss ***!
  \*****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-faq/style.scss"
/*!****************************************!*\
  !*** ./src/blocks/page-faq/style.scss ***!
  \****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-faq/block.json"
/*!****************************************!*\
  !*** ./src/blocks/page-faq/block.json ***!
  \****************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"slav-bank/faq","title":"Страница FAQ","category":"Страницы","icon":"editor-help","description":"Страница часто задаваемых вопросов.","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","supports":{"html":false,"anchor":true,"spacing":{"padding":true,"margin":true},"layout":true}}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/page-faq/index": 0,
/******/ 			"blocks/page-faq/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/page-faq/style-index"], () => (__webpack_require__("./src/blocks/page-faq/index.js")))
