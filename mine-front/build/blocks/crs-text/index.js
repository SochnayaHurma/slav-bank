...
const TEMPLATE = [paragraph('<strong>CRS (Common Reporting Standard, далее CRS)</strong> — Стандарт по автоматическому обмену информацией о финансовых счетах, разработанный <strong>ОЭСР</strong> (Организацией экономического сотрудничества и развития). <strong>CRS</strong> направлен на предотвращение глобального уклонения от уплаты налогов с использованием офшорных юрисдикций и обеспечения прозрачности налоговой информации. Российская Федерация в мае 2016 года подтвердила свое участие в выполнении требований CRS.'), paragraph('CRS в России реализован посредством принятия Федерального закона № 340-ФЗ от 27.11.2017г., дополнившего Главой 20.1 Налоговый кодекс РФ, и утверждения Постановления Правительства от 16.06.2018г. № 693 «О реализации международного автоматического обмена финансовой информацией с компетентными органами иностранных государств (территорий)».'), paragraph('В целях международного обмена информацией с иностранными налоговыми органами указанные документы обязывают Банк устанавливать налоговое резидентство клиентов, выгодоприобретателей и лиц, прямо или косвенно их контролирующих, и направлять сведения об иностранных налогоплательщиках в ФНС РФ. Банк определяет статус «налогового резидента» на основании полученной от Клиентов информации.'), paragraph('<strong>Клиенты, обязаны в соответствии с Главой 20.1 Налогового кодекса РФ предоставлять в Банк запрашиваемую информацию, позволяющую установить налоговое резидентство, в отношении самих себя, выгодоприобретателей и (или) лиц, прямо или косвенно их контролирующих.</strong>'), paragraph('В целях подтверждения Вашего налогового резидентства работник АО НКБ «СЛАВЯНБАНК» может запросить заполнить форму самосертификации, а также задать уточняющие вопросы.'), paragraph('С информацией по CRS для клиентов, размещенной на сайте Федеральной налоговой службы России можно ознакомиться <a href="https://data.nalog.ru/html/sites/www.340fzreport.nalog.ru/doc/a_obmen_info_v092020.pdf">по ссылке</a>.')];
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/crs-text/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/crs-text/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/crs-text/save.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/crs-text/editor.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/crs-text/style.scss");
...
/***/ "./src/blocks/crs-text/editor.scss"
/*!*****************************************!*\
  !*** ./src/blocks/crs-text/editor.scss ***!
  \*****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/crs-text/style.scss"
/*!****************************************!*\
  !*** ./src/blocks/crs-text/style.scss ***!
  \****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/crs-text/block.json"
/*!****************************************!*\
  !*** ./src/blocks/crs-text/block.json ***!
  \****************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"slav-bank/crs-text","title":"CRS: текст","category":"Компоненты темы","icon":"text-page","description":"Текстовая часть страницы CRS.","parent":["slav-bank/body-crs"],"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","supports":{"html":false,"anchor":true,"spacing":{"padding":true,"margin":true},"layout":true}}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/crs-text/index": 0,
/******/ 			"blocks/crs-text/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/crs-text/style-index"], () => (__webpack_require__("./src/blocks/crs-text/index.js")))
