...
/***/ "./src/blocks/page-tariffs-body/edit.js"
/*!**********************************************!*\
  !*** ./src/blocks/page-tariffs-body/edit.js ***!
  \**********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const TEMPLATE = [['slav-bank/kicker', {
  ...
  content: 'Выберите нужный раздел тарифов. Каждый раздел поддерживает редактирование карточек документов и ссылок в Gutenberg.'
}], ['core/list', {
  values: '<ul><li><a href="/tariffs-rub/">Тарифы по операциям в валюте РФ</a></li><li><a href="/tariffs-foreign-currency/">Тарифы по операциям в иностранной валюте</a></li><li><a href="/tariff-privetstvenny/">Тариф «Приветственный»</a></li><li><a href="/tariffs-slavny/">Тариф «Славный»</a></li><li><a href="/tariff-depositny/">Тариф «Депозитный»</a></li></ul>'
}], ['core/paragraph', {
  content: 'Перед публикацией проверяйте соответствие тарифных документов действующим условиям банка и внутренним регламентам.',
  className: 'muted'
}]];
...
/***/ "./src/blocks/page-tariffs-body/index.js"
/*!***********************************************!*\
  !*** ./src/blocks/page-tariffs-body/index.js ***!
  \***********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/page-tariffs-body/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/page-tariffs-body/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/page-tariffs-body/save.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/page-tariffs-body/editor.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/page-tariffs-body/style.scss");
...
/***/ "./src/blocks/page-tariffs-body/save.js"
/*!**********************************************!*\
  !*** ./src/blocks/page-tariffs-body/save.js ***!
  \**********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-tariffs-body/editor.scss"
/*!**************************************************!*\
  !*** ./src/blocks/page-tariffs-body/editor.scss ***!
  \**************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-tariffs-body/style.scss"
/*!*************************************************!*\
  !*** ./src/blocks/page-tariffs-body/style.scss ***!
  \*************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/page-tariffs-body/block.json"
/*!*************************************************!*\
  !*** ./src/blocks/page-tariffs-body/block.json ***!
  \*************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"slav-bank/body-tariffs","title":"Тарифы банка: содержимое","category":"Наполнение","icon":"media-document","description":"Карточка содержимого страницы Тарифы банка.","parent":["slav-bank/body-tariffs-bento"],"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","supports":{"html":false,"anchor":true,"spacing":{"padding":true,"margin":true},"layout":true}}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/page-tariffs-body/index": 0,
/******/ 			"blocks/page-tariffs-body/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/page-tariffs-body/style-index"], () => (__webpack_require__("./src/blocks/page-tariffs-body/index.js")))
