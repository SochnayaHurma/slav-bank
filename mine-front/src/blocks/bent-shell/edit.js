...
const TEMPLATE = [
	['core/heading', { placeholder: 'Заголовок секции' }],
	['core/paragraph', { placeholder: 'Основной контент слева...' }],
];
...
export default function Edit({ attributes, setAttributes }) {
	...
	return (
		<>
			...
			<section {...blockProps}>
				<div className="bento-shell-editor__main">
					<div className="bento-shell-editor__label">
						{__('Основной контент', 'mytheme')}
					</div>
					...
					<div className="stack">
						<div className="bento-card reveal is-in">
							<h3 style={{ margin: '6px 0 10px' }}>
								Курсы обмена валют в кассе банка
							</h3>
