        ...
        <div class="row" style="align-items: flex-start; gap: var(--s-4); flex-wrap: wrap">
          <div style="min-width: 280px; flex: 1 1 520px">
            ...
            <p style="max-width: 78ch" class="muted">
              Страница подготовлена к миграции: legacy-наполнение должно переноситься в editor через migration pattern,
              а шаблон оставляет новый визуальный shell и базовые document-блоки.
            </p>
        ...
        <div class="bento-card" style="padding: var(--s-4); position: relative">
          ...
          <div class="prose">
            <div class="entry-content">
              ...
              <p class="muted">Основной legacy-контент этой страницы должен быть перенесён в редактор через prefilled migration pattern. После переноса именно editor-content становится источником истины, а этот шаблон остаётся route-shell.</p>
              <p class="muted">До миграции в редакторе страница показывает только безопасный базовый shell: hero, полку годовых документов и нижний stack.</p>
            </div>
          </div>
        </div>
